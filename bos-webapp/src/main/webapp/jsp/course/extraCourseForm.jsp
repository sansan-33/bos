...
<div id="tutorcourse">
  <div style="padding-left:20px;background-color: rgb(242,246,235);">
    ...
    <form action="saveCourseForm" method="post" name="courseform" id="courseform">
		...
		<c:forEach var="extraclass" items="${requestScope.extraclasslist}" varStatus="rowCounter">
			<option value="${extraclass['value']}"  <c:if test="${requestScope.courseform['lookupclassid'] eq extraclass['value']}">selected</c:if> >
