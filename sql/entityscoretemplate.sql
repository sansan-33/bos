...
INSERT INTO entityscore (
  ...
  SELECT id,2017,categoryid,ranking,
	rankingfinancetype,
	rankingdistrict ,
	score ,
	parentscore ,
  ...
  INSERT INTO comment (
  comment,userlike,userdislike,entityid,userid,subject,grade,metric1,metric2,metric3,metric4,metric5,lastmodified,created,metric6,metadesc,keywords,ip,type,year)
  select c.comment,c.userlike,c.userdislike,c.entityid,c.userid,c.subject,c.grade,c.metric1,c.metric2,c.metric3,c.metric4,c.metric5,c.lastmodified,c.created,c.metric6,c.metadesc,c.keywords,c.ip,c.type,2017 from comment c, entity e where type='system' and c.userid=1 and year=2016 and c.entityid=e.id and e.categoryid in (0,1,2,5);
...
es1.sportntposmale = es2.sportntposmale
 ...
 where es1.entityid=es2.entityid and es1.year=2017 and es2.year=2016;
